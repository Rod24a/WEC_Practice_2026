...
def draw_dummy_9_player_bracket():
    ...
    # Layout (tweak these if you want more spacing)
    ...
    # --- Play-in ---
    p = match_box(X_PLAYIN, Y2, "Player 8", "Player 9")  # P1

    # --- Quarterfinals ---
    q1 = match_box(X_QF, Y0, "Player 1", "Winner (P1)")  # Q1
    q2 = match_box(X_QF, Y1, "Player 2", "Player 7")     # Q2
    q3 = match_box(X_QF, Y3, "Player 3", "Player 6")     # Q3
    q4 = match_box(X_QF, Y4, "Player 4", "Player 5")     # Q4

    # Connect play-in to Q1
    line(p[0], p[1], X_QF, q1[1])
    ...
    line(q4[0], q4[1], X_SF, s1[1])

    line(q2[0], q2[1], X_SF, s2[1])
